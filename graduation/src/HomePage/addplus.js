import { Tabs, TextareaItem,Card, Checkbox,Tag,DatePicker, List, Provider, Icon } from '@ant-design/react-native';
    ...
    fourContent(){
        switch (this.state.fourView) {
            ...
            case 3:
                return(
                    <View style={{ height: 640*s,marginTop:10*s}}>
                        <ImageBackground source={require('../../assets/11.jpg')} style={{height:300*s}}>
