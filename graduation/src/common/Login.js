                    ...
                    fetch('http://81.70.101.193:8005/register_log', {
                        ...
                        .then((res) => {
                            ...
                            if (this.state.login == false) {
                               ...
                               fetch(`http://81.70.101.193:8005/getpassword/${this.state.phone}`,{
                                   method:'GET',
                                   headers: {
                                    'Content-Type': 'text/plain; charset=UTF-8'
                                }
            ...
            <View style={{ flex: 1 }}>
                <ImageBackground style={{ height: 1300 * s }} resizeMode='cover' source={require('../../assets/19.jpg')}>
                    ...
                    <View style={{ marginTop: 50 * s, alignItems: 'center' }}>
                        <View>
                            <TouchableOpacity onPress={this.login} style={{ backgroundColor: '#A7BCF0', width: 500 * s, alignItems: 'center', height: 60 * s, borderRadius: 10 * s, justifyContent: 'center' }}>
